...
const addRole = () => {
    ...
    .then((answers) => {
        ...
        db.query(sql, [answers.newRole, answers.newSalary, answers.newRoleDept], (err, res) => {
            if (err) throw err
                console.log('Department added')
                init()
            })
...
const addEmployee = () => {
    ...
    db.query('SELECT * FROM roles', (err, res) => {
        ...
        .then ((answers) => {
            ...
            db.query(sql, [answers.firstName, answers.lastName, answers.empRole], (err, res) => {
                if (err) throw err
    ...
    db.query('SELECT * FROM roles', (err, res) => {
        ...
        db.query('SELECT * FROM employee', (err, res) => {
            ...
            .then((answers) => {
                ...
                db.query(sql, [{role_id: answers.upRole}, {id: answers.empName}], (err, res) => {
                    if (err) throw err
